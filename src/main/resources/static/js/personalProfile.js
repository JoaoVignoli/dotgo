...
function fillUserData(userData) {
    ...
    providerName.innerText = userData.name;
    ...
    if (userData.role == "CLIENT") {
        const tabProfile = document.getElementById("tabPerfil");
        const tabProdutos = document.getElementById("tabProdutos");
        const tabAvaliacoes = document.getElementById("tabAvaliacoes");
        const providerPortfolio = document.getElementById("providerPortfolio"); 
        const providerSpecialties = document.getElementById("providerSpecialties");
        const providerDescription = document.getElementById("providerDescription");

        tabProdutos.classList.add("hidden");
        tabProfile.classList.add("hidden");
        tabAvaliacoes.classList.add("active");
        providerSpecialties.classList.add("hidden");
        providerPortfolio.classList.add("hidden");
